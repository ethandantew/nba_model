...
features = [
    ...
    "OWN_TEAM_PACE_L10",
    "VS_TEAM_PACE_L10",
    "VS_FGM_AVGPM_LAST10G",
    "VS_FGA_AVGPM_LAST10G",
    "VS_FG3M_AVGPM_LAST10G",
    "VS_FG3A_AVGPM_LAST10G",
    "VS_FTM_AVGPM_LAST10G",
    "VS_FTA_AVGPM_LAST10G",
    "VS_OREB_AVGPM_LAST10G",
    "VS_DREB_AVGPM_LAST10G",
    "VS_AST_AVGPM_LAST10G",
    "VS_STL_AVGPM_LAST10G",
    "VS_BLK_AVGPM_LAST10G",
    "VS_TOV_AVGPM_LAST10G",
    "VS_PF_AVGPM_LAST10G",
    "VS_PTS_AVGPM_LAST10G",
    "VS_POTENTIAL_AST_AVGPM_LAST10G",
    "MIN_AVGLAST3GAMES",
    "FGM_AVGLAST3GAMES",
    "FGA_AVGLAST3GAMES",
    "FG3M_AVGLAST3GAMES",
...
raw_model_data["pred_accuracy"] = (
    raw_model_data[prop] - raw_model_data[f"predicted_{prop}"]
)
...
print(
    f"Coverage Probability for Lower Quantile ({lower_quantile}): {coverage_lower:.2%}"
)
print(
...
def predict_and_get_probabilities(player_name, vs_team, threshold):
    ...
    player_data = raw_model_data[
        (raw_model_data["PLAYER_NAME"] == player_name)
        & (raw_model_data["VS_TEAM_ABBREVIATION"] == vs_team)
    ].tail(1)
